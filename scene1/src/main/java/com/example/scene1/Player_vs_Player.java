...
public class Player_vs_Player {
   ...
   //braní si černá karty
    ...
    public void stoper(ActionEvent event) throws IOException, InterruptedException, InvocationTargetException {
        ...
        //pojistky pro chybějící informaci
        vy2 = -1;
        vy4 = -1;
        ll = "";
        if (poml == 1){
    ...
    public void enter(ActionEvent event) throws IOException {
        ...
        if (move == 0) {
            ...
            //vyřazení funkčnosti všech karet
            ...
            //změna barvy, fukčnosti a textu druhého hráče
